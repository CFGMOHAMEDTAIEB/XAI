...
def compress_file(input_path, output_path, mode="static", checkpoint=None, overwrite=False, chunk_size=DEFAULT_CHUNK, device=None, coder="arithmetic", quality="medium"):
