...
class ArithmeticEncoder:
    ...
    def _emit(self, bit: int) -> None:
        ...
        self.pending = 0
    def _write_internal(self, cum: Sequence[int], symbol: int) -> None:
    ...
    def write(self, cum: Sequence[int], symbol: int) -> None:
        ...
        self._write_internal(cum, symbol)
...
class ArithmeticDecoder:
    ...
    def _read_internal(self, cum: Sequence[int]) -> int:
        total = cum[-1]; width = self.high - self.low + 1
    ...
    def read(self, cum: Sequence[int]) -> int:
        validate_cumulative(cum)
        return self._read_internal(cum)
