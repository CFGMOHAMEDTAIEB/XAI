...
class GatedBlock(nn.Module):
    ...
    def forward(self,x,positions,cache=None,max_cache=256,numerical_debug=False,layer=None,observer=None):
        ...
        a,cache=self.attn(normalized_attention,positions,cache,max_cache,numerical_debug,layer,observer);x=x+a
        ...
        dropped=self.drop(out);_observe(observer,"ffn_dropout",dropped,layer)
