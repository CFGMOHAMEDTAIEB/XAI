...
from xai_compress.telemetry import collection_abs_max, collection_l2_norm
...
def main():
    ...
    for step,(x,y) in enumerate(loader,1):
        ...
        try:
            ...
            grad_norm=collection_l2_norm(grads)
            ...
            pmax=collection_abs_max(model.parameters())
            print(f"{step},{float(loss.detach()):.9g},{grad_norm:.9g},{float(logits.detach().abs().max()):.9g},N/A,{pmax:.9g},{float(scaler.get_scale()):.9g},true",flush=True)
