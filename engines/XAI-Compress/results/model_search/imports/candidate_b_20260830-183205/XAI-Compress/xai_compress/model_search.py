...
TERMINAL_STATUSES = {
    ...
    "INCONCLUSIVE", "KEEP_BASELINE", "PROMOTED",
}
NUMERICAL_FAILURES = {
...
class SearchConfig:
    ...
    def _validate(self) -> None:
        ...
        required = {"protected_baseline", "results_root", "checkpoint_root", "budget", "selection", "base_config", "candidates"}
...
class ModelSearchOrchestrator:
    ...
    def initialize(self) -> dict:
        ...
        atomic_json(self.current_best_path, {"candidate_id": "protected_gru", **baseline, "validated": True, "application_default_changed": False})
        self.save_state(state); self.update_leaderboard(state); return state

    def load_state(self) -> dict:
        state = json.loads(self.state_path.read_text(encoding="utf-8")); self.verify_protected_baseline(state); return state
